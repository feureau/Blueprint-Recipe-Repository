 ...
 * Original file: Z:\\app\\src\\main\\java\\com\\android\\vending\\billing\\IInAppBillingService.aidl
 */
...
android.os.Bundle _result = this.getPurchasesExtraParams(_arg0, _arg1, _arg2, _arg3, _arg4);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
int _result = this.consumePurchaseExtraParams(_arg0, _arg1, _arg2, _arg3);
reply.writeNoException();
reply.writeInt(_result);
return true;
}
...
/**
    * This API is currently under development.
    */
@Override public android.os.Bundle getPurchasesExtraParams(int apiVersion, java.lang.String packageName, java.lang.String type, java.lang.String continuationToken, android.os.Bundle extraParams) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
android.os.Bundle _result;
...
mRemote.transact(Stub.TRANSACTION_getPurchasesExtraParams, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = android.os.Bundle.CREATOR.createFromParcel(_reply);
}
...
@Override public int consumePurchaseExtraParams(int apiVersion, java.lang.String packageName, java.lang.String purchaseToken, android.os.Bundle extraParams) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
...
mRemote.transact(Stub.TRANSACTION_consumePurchaseExtraParams, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
static final int TRANSACTION_getPurchasesExtraParams = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_consumePurchaseExtraParams = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
...
/**
    * This API is currently under development.
    */
public android.os.Bundle getPurchasesExtraParams(int apiVersion, java.lang.String packageName, java.lang.String type, java.lang.String continuationToken, android.os.Bundle extraParams) throws android.os.RemoteException;
public int consumePurchaseExtraParams(int apiVersion, java.lang.String packageName, java.lang.String purchaseToken, android.os.Bundle extraParams) throws android.os.RemoteException;
}
